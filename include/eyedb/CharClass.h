...
#ifndef _EYEDB_CHAR_CLASS_H
#define _EYEDB_CHAR_CLASS_H
...
namespace eyedb {
  ...
  */
  ...
  /**
     Not yet documented.
  */
  class CharClass : public BasicClass {
    // ----------------------------------------------------------------------
    // CharClass Interface
    // ----------------------------------------------------------------------
  public:
    /**
       ...
       @param db
    */
    CharClass(Database *db = NULL);

    /**
       Not yet documented
       @param cl
    */
    CharClass(const CharClass &cl);

    /**
       Not yet documented
       @param cl
    */
    CharClass& operator=(const CharClass &cl);
    ...
    */
    ...
    /**
       ...
       @return
    */
    virtual CharClass *asCharClass() {return this;}

    /**
       Not yet documented
       @return
    */
    virtual const CharClass *asCharClass() const {return this;}

    // ----------------------------------------------------------------------
    // CharClass Private Part
    // ----------------------------------------------------------------------
  private:
    Status trace_realize(FILE*, int, unsigned int, const RecMode *) const;

    // ----------------------------------------------------------------------
    // CharClass Restricted Access (conceptually private)
    // ----------------------------------------------------------------------
  public:
    // E_XDR
