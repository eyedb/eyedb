...
#ifndef _EYEDB_BYTE_CLASS_H
#define _EYEDB_BYTE_CLASS_H
...
namespace eyedb {
  ...
  */
  ...
  /**
     Not yet documented.
  */
  class ByteClass : public BasicClass {
    // ----------------------------------------------------------------------
    // ByteClass Interface
    // ----------------------------------------------------------------------
  public:
    ...
    */
    ...
    /**
       ...
       @return
    */
    virtual Object *clone() const {return new ByteClass(*this);}
    ...
    */
    ...
    /**
       ...
       @return
    */
    virtual ByteClass *asByteClass() {return this;}

    /**
       Not yet documented
       @return
    */
    virtual const ByteClass *asByteClass() const {return this;}

    // ----------------------------------------------------------------------
    // ByteClass Private Part
    // ----------------------------------------------------------------------
  private:
    Status trace_realize(FILE*, int, unsigned int, const RecMode *) const;

    // ----------------------------------------------------------------------
    // ByteClass Restricted Access (conceptually private)
    // ----------------------------------------------------------------------
  public:
    // E_XDR
