...
public class DBProperty extends Root {
  ...
  public void setValue_(DBPropertyValue _value)
  throws org.eyedb.Exception {
    getClass(true).getAttributes()[3].setValue(this, new org.eyedb.Value(_value), 0);
  }

  public DBPropertyValue getValue_()
  throws org.eyedb.Exception {
    org.eyedb.Value __x;
  ...
  static org.eyedb.StructClass make(org.eyedb.StructClass DBProperty_class, org.eyedb.Schema m)
   throws org.eyedb.Exception {
    if (DBProperty_class == null)
      return new org.eyedb.StructClass("database_property", ((m != null) ? m.getClass("Root") : Root.idbclass));
    org.eyedb.Attribute[] attr = new org.eyedb.Attribute[4];
    int[] dims;

    dims = new int[1];
    dims[0] = -1;
    attr[2] = new org.eyedb.Attribute(((m != null) ? m.getClass("char") : org.eyedb.Char.idbclass), idbclass, "key", 2, false, 1, dims);
