...
public class TimeInterval extends Root {
  ...
  static org.eyedb.StructClass make(org.eyedb.StructClass TimeInterval_class, org.eyedb.Schema m)
   throws org.eyedb.Exception {
    if (TimeInterval_class == null)
      return new org.eyedb.StructClass("time_interval", ((m != null) ? m.getClass("Root") : Root.idbclass));
