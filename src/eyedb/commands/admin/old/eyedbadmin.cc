		  ...
		  eyedbsm::Oid::NX nbobjs = DEF_NBOBJS, int dbid = 0)
{
  ...
  if (!datafiles_cnt) {
    ...
    datafiles[1] = (char*)"";/*@@@@warning cast*/
    datafiles[2] = (char*)DEF_DATSIZE_STR;/*@@@@warning cast*/
...
get_datafile_opts(char *s, char *datafiles[], int *datafiles_cnt)
{
  ...
  if (!p) {
    ...
    datafiles[(*datafiles_cnt)++] = (char*)"";/*@@@@warning cast*/
    datafiles[(*datafiles_cnt)++] = (char*)DEF_DATSIZE_STR;/*@@@@warning cast*/
    datafiles[(*datafiles_cnt)++] = (char*)DEF_SIZESLOT_STR;/*@@@@warning cast*/
    datafiles[(*datafiles_cnt)++] = (char*)DEF_DATTYPE_STR;/*@@@@warning cast*/
    return 0;
  }
...
str_sys_mode(SysAccessMode sysmode)
{
  ...
  *sysstr = 0;
  ...
  concat = (char*)"";/*@@@@warning cast*/

  XC(DBCreateSysAccessMode, (char*)"DB_CREATE_SYSACCESS_MODE",/*@@@@warning cast*/
     sysmode, sysstr, concat);
  XC(AddUserSysAccessMode, (char*)"ADD_USER_SYSACCESS_MODE",/*@@@@warning cast*/
     sysmode, sysstr, concat);
  XC(DeleteUserSysAccessMode, (char*)"DELETE_USER_SYSACCESS_MODE",/*@@@@warning cast*/
     sysmode, sysstr, concat);
  XC(SetUserPasswdSysAccessMode, (char*)"SET_USER_PASSWD_SYSACCESS_MODE",/*@@@@warning cast*/
     sysmode, sysstr, concat);
...
str_user_mode(DBAccessMode usermode)
{
  ...
  *userstr = 0;
  ...
  XC(ReadWriteExecDBAccessMode, (char*)"READ_WRITE_EXEC_DBACCESS_MODE",/*@@@@warning cast*/
     usermode, userstr, concat)
  else XC(ReadExecDBAccessMode, (char*)"READ_EXEC_DBACCESS_MODE",/*@@@@warning cast*/
	  usermode, userstr, concat)
    else XC(ReadWriteDBAccessMode, (char*)"READ_WRITE_DBACCESS_MODE",/*@@@@warning cast*/
	  usermode, userstr, concat)
      else XC(ReadDBAccessMode, (char*)"READ_DBACCESS_MODE",/*@@@@warning cast*/
	  usermode, userstr, concat);
